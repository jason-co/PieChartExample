...
namespace PieCharts
{
	...
	public partial class SimplePieChart
	{
		...
		public static readonly DependencyProperty InnerPieSliceFillProperty =
		   DependencyProperty.Register( "InnerPieSliceFill", typeof( Brush ), typeof( SimplePieChart ), new PropertyMetadata( CreateBrush( "#939496" ), OnPiePropertyChanged ) );

		public static readonly DependencyProperty OuterPieSliceFillProperty =
		   DependencyProperty.Register( "OuterPieSliceFill", typeof( Brush ), typeof( SimplePieChart ), new PropertyMetadata( CreateBrush( "#D0D1D3" ), OnPiePropertyChanged ) );
